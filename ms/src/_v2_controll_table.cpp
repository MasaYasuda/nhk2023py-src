...
int _RESOLUTION[6] = {512, 512, 256, 256, 512, 512};
...
float _GAIN_SPEED_FFPID[6][4] = {
    ...
    {__common_gain_speed_ffpid[0], __common_gain_speed_ffpid[1], __common_gain_speed_ffpid[2], __common_gain_speed_ffpid[3]},
    {0.032,0,0.0003,0},{0.032,0,0.0003,0}, 
...
float _INTEGRAL_VELOCITY_ERROR_LIMIT[6] = {
    __common_integral_speed_error_limit, __common_integral_speed_error_limit, 50000,50000,10000,10000};
byte _MODE[6] = {0};
