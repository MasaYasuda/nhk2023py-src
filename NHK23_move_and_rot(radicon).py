...
try:
    ...
    direction_config_array1 =[3,0,0,0,0,0] #回転が逆だったら3にする
    direction_config_array2 =[3,0,0,0,0,0] #回転が逆だったら3にする
    direction_config_array3 =[0,0,0,0,0,0] #回転が逆だったら3にする
    ...
    while True:
        ...
        time.sleep(0.1)
        transmitter1.write_single_auto(1,omni_output[1])
        time.sleep(0.1)
        transmitter2.write_single_auto(2,omni_output[2])
        time.sleep(0.1)
        transmitter3.write_single_auto(3,omni_output[3])
        time.sleep(0.1)
